...
$string['audioformat'] = 'Audio format';
$string['audioformatimaadpcm'] = 'ImaADPCM';
$string['audioformatspeex'] = 'Speex';

$string['samplingrate'] = 'Sampling rate';
$string['samplingratelow'] = 'Low quality';
